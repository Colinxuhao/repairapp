<template>
<div class="over">
	<header-top :title="'结束合同历史记录'"></header-top>
	<div class="lists">
...
export default{
	...
	methods:{ 
		async initData(){
			let res = await this.myHttp(GetResponsePayData,{"SearchData":{"Type":1},"PageIndex":this.PageIndex,"PageSize":10,"Order":"EntrustContractNo","DescOrAsc":0});
