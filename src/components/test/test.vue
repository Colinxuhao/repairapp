...
export default{
	...
	methods:{
		initData(){
			...
			let scroll = new BScroll(listWrapper,{  
			}); 
		...
		reloadData(){
			...
			var html = '<li class="list-item"><span>我是新增数据' + Math.random() + '</span></li><li class="list-item"><span>我是新增数据' + Math.random() + '</span></li>' +'<li class="list-item"><span>我是新增数据' + Math.random() + '</span></li>';
